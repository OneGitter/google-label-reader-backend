...
import google.generativeai as genai
 ...
 # Directly use your API key. Replace <your_actual_api_key>
...
response = chat_session.send_message(input("enter your dish:"))
